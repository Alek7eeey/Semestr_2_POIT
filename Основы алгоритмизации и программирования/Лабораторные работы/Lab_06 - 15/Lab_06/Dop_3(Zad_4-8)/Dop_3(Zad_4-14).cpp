...
Найти сумму отрицательных элементов, кратных 5, 
...
void sum(list*);  //функция подсчета суммы отрицательных элементов, кратных 5
void toFile(list*& p);
...
void menu(void)  //Вывод меню 
{
	...
	cout << " 3 - Вычисление суммы отрицательных элементов, кратных 5" << endl;
