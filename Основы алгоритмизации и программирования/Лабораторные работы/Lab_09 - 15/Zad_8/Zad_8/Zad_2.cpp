//функция поиска минимального  элемента списка по одному из выбранных полей
//функция поиска максимального  элемента списка по одному из выбранных полей
//функция подсчёта числа элементов списка с заданным значением x.
