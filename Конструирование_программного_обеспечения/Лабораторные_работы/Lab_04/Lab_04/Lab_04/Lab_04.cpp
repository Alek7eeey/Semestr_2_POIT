...
void main()
{
	...
	string name[size_of_month] = { "Январь", "Февраль", "Март", "Апрель", "Май", "Июнь", "Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь"};
...
int function_visYear(int year1, int month_day1[])
{
	if (year1 % 4 == 0 && year1 % 100 != 0)
	{
		...
		cout << "День программиста празднуется 12 сентября!" << endl;
		month_day1[1] = 29;
	...
	else
	{
		...
		cout << "День программиста празднуется 13 сентября!" << endl;
	}
	return month_day1[1];
}