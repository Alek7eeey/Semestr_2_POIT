/*пример номер 3 из лекции номер 7*/
#include <iostream>
#include <vector>
#include <algorithm>
using namespace std;
...
void main()
{
	...
	int num_items3 = count_if(v.begin(), v.end(), [](int i) {return i % 3 == 0; }); //Возвращает количество элементов в группе, которые удовлетворяют условию
